...
// floppyfish_shark.cpp) includes this and implements the same five-function
// contract below;
...
// vent field, and a murky, hazard-taped shark territory.
typedef enum {
    FF_THEME_REEF = 0, 
    FF_THEME_SHIP = 1, 
    FF_THEME_CAVE = 2, 
...
void ff_draw_party_column(cairo_t *cr, double x, double y0, double y1, double width, double seed, bool tip_at_y1);
void ff_draw_volcanic_column(cairo_t *cr, double x, double y0, double y1, double width, double seed, bool tip_at_y1);
void ff_draw_shark_column(cairo_t *cr, double x, double y0, double y1, double width, double seed, bool tip_at_y1);
...
void ff_party_sky_colors(double *top_r, double *top_g, double *top_b, double *bot_r, double *bot_g, double *bot_b);
void ff_volcanic_sky_colors(double *top_r, double *top_g, double *top_b, double *bot_r, double *bot_g, double *bot_b);
void ff_shark_sky_colors(double *top_r, double *top_g, double *top_b, double *bot_r, double *bot_g, double *bot_b);
