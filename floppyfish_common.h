...
// Six visual themes the run cycles through as the fish travels: coral reef,
// a sunken pirate ship, a dark cave, the ruins of Atlantis, a sky-high
// rainbow realm, and a murky prehistoric bone-yard.
typedef enum {
    FF_THEME_REEF = 0, FF_THEME_SHIP = 1, FF_THEME_CAVE = 2, FF_THEME_ATLANTIS = 3,
    FF_THEME_RAINBOW = 4, FF_THEME_DINO = 5, FF_THEME_COUNT = 6
} FFTheme;
